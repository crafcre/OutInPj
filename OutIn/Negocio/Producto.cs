...
namespace Negocio
{
    public class Producto:Respuesta
    {
        ...
        public bool registraProducto(string nombre, int cant,decimal precio, int unidades, int sMin, int sMax, string cantXuni, string cat)
        {// registrar una categoria a la base de datos
            try
            {
                ...
                datos.crearProducto(nombre,cant,precio,unidades,sMin,sMax,cantXuni,c);
                return true;
            }
            catch (Exception ex)
            {
